      ...
      <div class="slim-mainpanel">
        <div class="container">
          <div class="slim-pageheader">
            ...
            <h6 class="slim-pagetitle">Statistics</h6>
          </div><!-- slim-pageheader -->
...
@push('styles')
    ...
    <link href="{{ asset('dashboard/lib/rickshaw/css/rickshaw.min.css') }}" rel="stylesheet">
...
@push('scripts')
    ...
    <script src="{{ asset('dashboard/lib/d3/js/d3.js') }}"></script>
    <script src="{{ asset('dashboard/lib/rickshaw/js/rickshaw.min.js') }}"></script>
    <script src="{{ asset('dashboard/lib/jquery.sparkline.bower/js/jquery.sparkline.min.js') }}"></script>

    <script src="{{ asset('dashboard/lib/Flot/js/jquery.flot.js') }}"></script>
    <script src="{{ asset('dashboard/lib/Flot/js/jquery.flot.resize.js') }}"></script>
    <script src="{{ asset('dashboard/lib/peity/js/jquery.peity.js') }}"></script>
