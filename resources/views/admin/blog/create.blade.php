                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12">                                     
                            <div class="form-group">
                                ...
                                <textarea class="form-control" type="text" name="short_description" rows="5">{{ old('short_description') }}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-12">
                            <div class="">
                                ...
                                <textarea class="editable tx-16 bd pd-30 tx-inverse" id="" name="description" rows="6">{{ old('description') }}</textarea>
                            </div>
                        </div>                                                                           
                        <div class="col-lg-6">
                            <div class="form-group">
