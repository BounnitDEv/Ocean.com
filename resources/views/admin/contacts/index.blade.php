                ...
                <table class="table mg-b-0 tx-12">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td class="valign-middle">{{ $contact->created_at->format('Y-m-d') }}</td>
                      <td class="valign-middle">{{ $contact->fullname }}</td>
                      <td class="valign-middle">{{ $contact->email }}</td>
                      <td class="valign-middle">{{ $contact->phone }}</td>
                      <td class="valign-middle">{{ $contact->message }}</td>
                      <td class="valign-middle text-center">
                        <a href="{{ route('admin.contact.destroy', ['id' => $contact->id] ) }}" class="tx-gray-600 text-danger tx-24"><i class="fa fa-close mg-r-5"></i> </a>
                      </td>
