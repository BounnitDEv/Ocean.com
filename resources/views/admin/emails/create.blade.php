        ...
        <div class="container">
          <div class="slim-pageheader">
            <ol class="breadcrumb slim-breadcrumb">
              ...
              <li class="breadcrumb-item active" aria-current="page">Créer nouvelle Collection</li>
            </ol>
            <h6 class="slim-pagetitle">Créer nouvelle Collection</h6>
          </div><!-- slim-pageheader -->
                  ...
                  <div class="row mg-b-25">
                    <div class="col-lg-8">
                      <div class="form-group">
                        ...
                        <input class="form-control" type="text" name="title" placeholder="Enter le titre du collection" value="{{ old('title') }}">
                      </div>
                    </div><!-- col-4 -->
                    <div class="col-lg-4">
                    ...
                    <div class="col-lg-6">
                      <div class="form-group">
                        ...
                        <input class="form-control" type="text" name="slogan" placeholder="Enter le slogan du collection" value="{{ old('slogan') }}">
                      </div>
                    </div><!-- col-4 -->
                    <div class="col-lg-6">
                      <div class="form-group">
                        <label class="form-control-label">Promo: <span class="tx-danger">*</span></label>
                        <input class="form-control" type="text" name="promo" placeholder="Enter le promo du collection" value="{{ old('promo') }}">
                      </div>
                    </div><!-- col-4 -->
                    <div class="col-lg-6">
                      <div class="form-group">
